...
function Screenshots() {
  ...
  return (
    <Wrapper title='Start your yoga journey now!' ariaLabel='Screenshots' className='w-full h-fit flex space-x-3 justify-center md:justify-start relative -z-10'>
        <img src={accent} className='md:hidden min-w-[calc(100%+24px)] h-fit absolute' alt='App screenshot - accent'/>
