...
function Screenshots() {
  ...
  return (
    <Wrapper title='Start your yoga journey now!' ariaLabel='Screenshots' className='w-full h-fit flex space-x-3 justify-center md:justify-start'>
        <img src={screenshot1} className='w-fit max-h-[350px] md:max-h-[300px] object-contain mt-7' alt='App screenshot - activity'/>
        <img src={screenshot2} className='w-fit max-h-[350px] md:max-h-[300px] object-contain mt-16' alt='App screenshot - articles'/>
    </Wrapper>
  )
}
